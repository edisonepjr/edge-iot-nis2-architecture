...
A proposta apresenta uma arquitetura de baixo custo baseada em dispositivos ESP32 organizados em cluster, com mecanismos de resiliência e segurança embarcada alinhados à diretiva NIS2.
...
Ver pseudocódigo em: `/src/pseudocode.txt`

## 📊 Dados de Experimento

O diretório `/data` contém amostras simplificadas das medições de latência utilizadas no artigo.
